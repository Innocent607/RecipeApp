...
public class RecipeToRecipeCommand implements Converter<Recipe, RecipeCommand> {
    ...
    private final NotesToNotesCommand notesConvereter;

    public RecipeToRecipeCommand(CategoryToCategoryCommand categoryConverter,
                                 IngredientToIngredientCommand ingredientConverter,
                                 NotesToNotesCommand notesConvereter) {
        this.categoryConverter = categoryConverter;
        this.ingredientConverter = ingredientConverter;
        this.notesConvereter = notesConvereter;
    }
    ...
    public RecipeCommand convert(Recipe source) {
        ...
        command.setNotes(notesConvereter.convert(source.getNotes()));
